...
/* Include files */
#include "_coder_simple_vec_dot_product_info.h"
...
mxArray *emlrtMexFcnProperties()
{
  ...
  mxSetFieldByNumber(xEntryPoints, 0, 0, mxCreateString("simple_vec_dot_product"));
...
/* End of code generation (_coder_simple_vec_dot_product_info.c) */
