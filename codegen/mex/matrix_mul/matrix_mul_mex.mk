...
MAKEFILE = matrix_mul_mex.mk

include matrix_mul_mex.mki


SRC_FILES =  \
	matrix_mul_initialize.c \
...
MEX_FILE_NAME_WO_EXT = matrix_mul_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/matrix_mul"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/matrix_mul/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/matrix_mul/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/matrix_mul/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/matrix_mul/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
