...
MAKEFILE = hdl_matmul_mex.mk

include hdl_matmul_mex.mki
...
MEX_FILE_NAME_WO_EXT = hdl_matmul_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/hdl_matmul"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/hdl_matmul/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/hdl_matmul/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/hdl_matmul/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/hdl_matmul/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
