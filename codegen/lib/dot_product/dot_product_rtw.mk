...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/dot_product.a
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/dot_product.a
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/codegen/lib/dot_product -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=dot_product -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
%.o : $(START_DIR)/codegen/lib/dot_product/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/dot_product/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
