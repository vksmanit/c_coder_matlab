...
MAKEFILE = dot_product_mex.mk

include dot_product_mex.mki
...
MEX_FILE_NAME_WO_EXT = dot_product_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/dot_product"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/dot_product/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/dot_product/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/dot_product/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/dot_product/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
